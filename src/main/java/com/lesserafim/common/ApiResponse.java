...
public class ApiResponse<T> {
    ...
    private final static String DOUBLE_LOGIN_MESSAGE = "new login detected";
    ...
    public static <T> ApiResponse<T> doubleLogin() {
        return new ApiResponse<T>(new ApiResponseHeader(DOUBLE_LOGIN_CODE, DOUBLE_LOGIN_MESSAGE), null);
    }
